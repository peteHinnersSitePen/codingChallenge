...
export class CommentService {
  ...
  updateComment(issueId: number, commentId: number, request: CreateCommentRequest): Observable<Comment> {
    return this.http.put<Comment>(`${this.apiUrl}/${issueId}/comments/${commentId}`, request);
  }
